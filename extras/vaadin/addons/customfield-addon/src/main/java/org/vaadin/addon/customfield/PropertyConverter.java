 ...
 * 
 * This class implements {@link Property} and some other interfaces, and
 * forwards calls to another property while performing value conversions.
 * 
 * PC if the property type, FC is the field internal value type. All values
 * returned by the data source must be compatible with PC, and values returned
 * by the field with FC.
 */
