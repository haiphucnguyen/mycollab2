...
public class BasicTest extends AbstractTest {
	...
	Component getTestComponent() {
		...
		uploadField3.setCaption("Storagemode: /tmp/ , fieldType:"
		...
		uploadFieldHtml5Configured.setCaption("Storagemode: /tmp/ , fieldType:"
				+ uploadFieldHtml5Configured.getFieldType()
				+ " just images, max 1000000");
		...
		multiFileUpload2.setRootDirectory("/tmp/");
