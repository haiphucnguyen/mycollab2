 ...
 * UploadField also provides built in {@link ProgressBar} and displays (partly)
 * the uploaded file. What/how is displayed can be easily modified by overriding
 * {@link #updateDisplay()} method.
 * 
 * <p>
...
public class UploadField extends VerticalLayout implements Field,
	...
	private Label display = new Label("", ContentMode.HTML);
