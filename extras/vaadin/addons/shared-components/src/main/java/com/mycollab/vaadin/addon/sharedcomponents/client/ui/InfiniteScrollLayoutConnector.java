package com.mycollab.vaadin.addon.sharedcomponents.client.ui;

import com.mycollab.vaadin.addon.sharedcomponents.InfiniteScrollLayout;
import com.mycollab.vaadin.addon.sharedcomponents.client.shared.ScrollReachBottomRpc;
...
public class InfiniteScrollLayoutConnector extends AbstractExtensionConnector implements AttachEvent.Handler {
	...
	private native void initHandler() /*-{
		var self = this;
		this.@com.mycollab.vaadin.addon.sharedcomponents.client.ui.InfiniteScrollLayoutConnector::scrollHandler = function() {
			self.@com.mycollab.vaadin.addon.sharedcomponents.client.ui.InfiniteScrollLayoutConnector::callRpc()();
		};
	}-*/;
	...
	private native void removeScrollHandler(Element element) /*-{
		var self = this;
		element.removeEventListener('scroll', self.@com.mycollab.vaadin.addon.sharedcomponents.client.ui.InfiniteScrollLayoutConnector::scrollHandler);
	}-*/;

	private native void addScrollHandler(Element element) /*-{
		var self = this;
		element.addEventListener('scroll', self.@com.mycollab.vaadin.addon.sharedcomponents.client.ui.InfiniteScrollLayoutConnector::scrollHandler);
	}-*/;
