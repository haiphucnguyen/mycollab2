...
public class ColumnParser implements ISqlParser {
	...
	public Object parse(ResultSet rs) throws Exception {
		...
		int decimalDigits = rs.getInt(INFORMATION_SCHEMA.COLUMNS.DECIMAL_DIGITS);
		...
		boolean isNullAble = rs.getString(INFORMATION_SCHEMA.COLUMNS.IS_NULLABLE).equals("YES");
		boolean isAutoIncrement = rs.getString(INFORMATION_SCHEMA.COLUMNS.IS_AUTOINCREMENT).equals("YES");		
