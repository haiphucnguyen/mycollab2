...
public class Schema {
	...
	private void loadUniqueIndex(String tableName) throws Exception {
		List<Object> lsObjects = DataAdapter.getData(
				INFORMATION_SCHEMA.UNIQUE_INDEX_INFO.getMethodName(),
				INFORMATION_SCHEMA.UNIQUE_INDEX_INFO.getParameterTypes(),
				INFORMATION_SCHEMA.UNIQUE_INDEX_INFO.getQueryParameters(tableName),
	...
	private void loadForeignKeyConstraint(String tableName) throws Exception {
		List<Object> lsObjects = DataAdapter.getData(
				...
				INFORMATION_SCHEMA.FOREIGN_KEY_CONSTRAINT.getQueryParameters(tableName),
	...
	public static final Schema loadSchema() throws Exception {
