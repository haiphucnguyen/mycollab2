...
public class DataAdapter {
	...
	public static final List<Object> getData(String methodName, Class<?>[] parameterTypes, Object[] arguments,
			ISqlParser parser) throws Exception {
		Properties prop = new Properties();
		prop.put("user", ApplicationConfigurations
				.getProperty(ApplicationConfigurations.USER_NAME));
		prop.put("password", ApplicationConfigurations
		...
		Method method = metaData.getClass().getMethod(methodName, parameterTypes);
		if (null != method) {
