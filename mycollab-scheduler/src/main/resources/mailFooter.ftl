<tr>
  <td style="width: 100%;">
    <div style="font-size: 11px; vertical-align: middle; display:inline-flex; float: left; padding: 10px 30px;">
      Copyright by <a href="https://www.mycollab.com">&nbsp;©&nbsp; MyCollab ${current_year}</a>. All rights reserved.&nbsp;Connect with us:&nbsp;
