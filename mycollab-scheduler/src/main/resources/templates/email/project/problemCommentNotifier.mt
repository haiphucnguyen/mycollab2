	...
	<table width="650" cellpadding="0" cellspacing="0" border="0" style="margin: 0px auto;">
		...
		<tr>
			<td style="background: url('${defaultUrls.cdn_url}border_large_center_new.png') repeat-y 0 0 transparent; color: #4e4e4e; font: 13px 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; padding: 10px 30px 0px;">
				...
				<div style="display: block; padding: 8px; background-color: rgb(247, 228, 221);">Just wanna let you know that a new comment has been created by <a href="$userComment" style="color: rgb(216, 121, 55); text-decoration: underline;">$!comment.changeByUserFullName</a> to the problem <a href="" style="color: rgb(216, 121, 55);">$!problem.issuename</a> in project <a href="$!hyperLinks.projectUrl" style="color: rgb(216, 121, 55); text-decoration: underline;">$!hyperLinks.projectName</a>. Here're details about it:</div>
