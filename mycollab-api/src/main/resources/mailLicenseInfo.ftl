        ...
        <td style="padding: 10px 30px">
            ...
            <p>
                To activate MyCollab, please follow the instruction <a
                    href="https://docs.mycollab.com/user-guide/enter-the-license-for-mycollab-ultimate-edition/">Enter the license for MyCollab Ultimate Edition</a>
            </p>
            <p>We hope you enjoy MyCollab! If you have any issue, please contact us at <a href="https://mycollab.userecho.com/en/">Support forum</a></p>
