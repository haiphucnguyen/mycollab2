			...
			<div id="mainBody">
				...
				<div>
					<table style="width: 100%" cellspacing="0" cellpadding="0">
					 	<tr>
					 		<td style="width: 50%; vertical-align:top; padding-top:12px;font-size: 18px">招待を受諾していただきありがとうございます！MyCollabに新規登録の場合は、パスワードを入力してください：</td>
					 		<td style="width: 50%; vertical-align: top;">
								<div id="mainContent">
					  				 <div>
										...
										<tbody>
										<tr>
											<td><label for="password"><span style="font-size:14px">パスワード:</span></label></td>
										</tr>
										<tr>
										...
										<tr>
											<td><label for="password"><span style="font-size:14px">パスワードを確認:</span></label></td>
										</tr>
										<tr>
									...
									<div style="padding-top: 15px; text-align: right;">
										<button class="v-button v-button-orangebtn" type="button" onclick="return createAccount();"><span style="font-family: 'verdana';font-size: 15px;">保存</span></button>&nbsp&nbsp&nbsp
										<button class="v-button v-button-graybtn" type="button" onclick="return cancel();"><span style="font-family: 'verdana';font-size: 15px;">キャンセル</span></button>
									</div>
								</div>
							</td>
					 	</tr>
