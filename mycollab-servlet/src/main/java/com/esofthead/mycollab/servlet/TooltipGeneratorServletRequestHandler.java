    ...
    protected void onHandleRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (ProjectTypeConstants.PROJECT.equals(type)) {
                ...
                html = ProjectTooltipGenerator.generateToolTipProject(locale, dateFormatInstance.getDateFormat(), project, siteURL, timeZone);
                ...
                html = ProjectTooltipGenerator.generateToolTipMilestone(locale, dateFormatInstance.getDateFormat(), mileStone, siteURL, timeZone, false);
                ...
                html = ProjectTooltipGenerator.generateToolTipBug(locale, dateFormatInstance.getDateFormat(), bug, siteURL, timeZone, false);
                ...
                html = ProjectTooltipGenerator.generateToolTipTask(locale, dateFormatInstance.getDateFormat(), task, siteURL, timeZone, false);
                ...
                html = ProjectTooltipGenerator.generateToolTipRisk(locale, dateFormatInstance.getDateFormat(), risk, siteURL, timeZone, false);
                ...
                html = ProjectTooltipGenerator.generateToolTipVersion(locale, dateFormatInstance.getDateFormat(), version, siteURL, timeZone);
                ...
                html = ProjectTooltipGenerator.generateToolTipStandUp(locale, dateFormatInstance.getDateFormat(), standup, siteURL, timeZone);
                ...
                html = CrmTooltipGenerator.generateToolTipContact(locale, dateFormatInstance.getDateFormat(), contact, siteURL, timeZone);
                ...
                html = CrmTooltipGenerator.generateTooltipCampaign(locale, dateFormatInstance.getDateFormat(), account, siteURL, timeZone);
                ...
                html = CrmTooltipGenerator.generateTooltipOpportunity(locale, dateFormatInstance.getDateFormat(), opportunity, siteURL, timeZone);
                ...
                SimpleMeeting meeting = service.findById(
                        Integer.parseInt(typeId), sAccountId);
                html = CrmTooltipGenerator.generateToolTipMeeting(locale, dateFormatInstance.getDateFormat(), meeting, siteURL, timeZone);
                ...
                html = CrmTooltipGenerator.generateToolTipCall(locale, dateFormatInstance.getDateFormat(), call, siteURL, timeZone);
                ...
                html = CrmTooltipGenerator.generateToolTipCrmTask(locale, dateFormatInstance.getDateFormat(),
