...
CREATE TABLE m_form_custom_field_value (
  ...
  text4 varchar(2000),
  text5 varchar(2000),
  textarea1 varchar(2000),
  textarea2 varchar(2000),
  textarea3 varchar(2000),
  textarea4 varchar(2000),
  textarea5 varchar(2000),
  ...
  multipick1 varchar(2000),
  multipick2 varchar(2000),
  multipick3 varchar(2000),
  multipick4 varchar(2000),
  multipick5 varchar(2000),
  PRIMARY KEY (id)
) ;
...
CREATE TABLE m_prj_standup (
  ...
  sAccountId integer NOT NULL,
  projectId integer NOT NULL,
  whatlastday varchar(2000),
  whattoday varchar(2000),
  whatproblem varchar(2000),
