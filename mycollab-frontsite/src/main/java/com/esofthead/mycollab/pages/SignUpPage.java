	...
	public SignUpPage(final PageParameters parameters) {
		...
		try {
			if (session.getAttribute("authManager") != null) {
				...
				selectedServiceId = manager.getCurrentAuthProvider()
						.getProviderId();
		...
		final String externalServiceId = selectedServiceId;
				...
				new AbstractReadOnlyModel<String>() {
					...
					public String getObject() {
						if (externalServiceId == ""
								|| externalServiceId == "googleplus") {
							if (externalServiceId == "googleplus")
		...
		if (externalServiceId != "" && externalServiceId != "googleplus")
		...
		facebookLink.add(AttributeModifier.replace("class",
				new AbstractReadOnlyModel<String>() {
					...
					public String getObject() {
						if (externalServiceId == ""
								|| externalServiceId == "facebook") {
							if (externalServiceId == "facebook")
								return "service-selected";
							return "service-enabled";
						}
						return "service-disabled";
		...
		if (externalServiceId != "" && externalServiceId != "facebook")
		...
		linkedInLink.add(AttributeModifier.replace("class",
				new AbstractReadOnlyModel<String>() {
					...
					public String getObject() {
						if (externalServiceId == ""
								|| externalServiceId == "LinkedIn") {
							if (externalServiceId == "LinkedIn")
								return "service-selected";
							return "service-enabled";
						}
						return "service-disabled";
		...
		if (externalServiceId != "" && externalServiceId != "LinkedIn")
		...
		yahooLink.add(AttributeModifier.replace("class",
				new AbstractReadOnlyModel<String>() {
					...
					public String getObject() {
						if (externalServiceId == ""
								|| externalServiceId == "yahoo") {
							if (externalServiceId == "yahoo")
								return "service-selected";
							return "service-enabled";
						}
						return "service-disabled";
		...
		if (externalServiceId != "" && externalServiceId != "yahoo")
