...
public final class GoogleOauthHelper {
	 ...
	 */
	private static final String CLIENT_ID = "1095048585699-htc9so8ta1aamt3pdmq50lvoos07pjbi.apps.googleusercontent.com";
	/**
	 * Please provide a value for the CLIENT_SECRET constant before proceeding,
	 * set this up at https://code.google.com/apis/console/
	 */
	private static final String CLIENT_SECRET = "PPAPCdK8nH6H-o4nKwIZX4dv";

	/**
	 * Callback URI that google will redirect to after successful authentication
	 */
	private static final String CALLBACK_URI = "http://localhost:8080/mycollab-frontsite/oauth2callback";
	...
	public static void main(String[] args) {
		System.out.println(new GoogleOauthHelper().buildLoginUrl());
	}
