...
public class ContactResourceImpl implements ContactResource {
	...
	public Response submit(@Form final ContactForm entity) {
		...
		mailRelayService.saveRelayEmail(new String[] { "Sir" },
				new String[] { "hainguyen@esofthead.com" }, contentGenerator.parseString("New guy wanna contact you!"),
				contentGenerator.parseFile(contactUsTemplate, SiteConfiguration.getDefaultLocale()));
