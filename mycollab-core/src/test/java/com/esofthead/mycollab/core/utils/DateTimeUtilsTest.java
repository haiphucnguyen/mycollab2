...
public class DateTimeUtilsTest {
    ...
    public void testDateWithZone() {
        ...
        Date newDate3 = DateTimeUtils.trimHMSOfDate(DateTimeUtils.convertTimeFromSystemTimezoneToUTC(value));
    ...
    public void testConvertCurrentTimezoneToUTC() {
        ...
        Date dateUTC = DateTimeUtils.convertTimeFromSystemTimezoneToUTC(date.getTime());
