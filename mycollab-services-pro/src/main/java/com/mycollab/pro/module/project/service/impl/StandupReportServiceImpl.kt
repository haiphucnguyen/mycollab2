...
class StandupReportServiceImpl : DefaultService<Int, StandupReportWithBLOBs, StandupReportSearchCriteria>(), StandupReportService {

    @Autowired
    private val standupReportMapper: StandupReportMapper? = null

    @Autowired
    private val standupReportMapperExt: StandupReportMapperExt? = null
