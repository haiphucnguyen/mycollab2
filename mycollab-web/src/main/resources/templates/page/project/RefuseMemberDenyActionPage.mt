	...
	<div id="container">
		...
		<div id="body" style="background-color: rgb(239, 239, 239); width: 100%;">
			...
			<div style="padding-left: 300px; padding-right: 250px; background-color: rgb(239, 239, 239); height: 100%;">
				<div id="mainBody">
					<div id="title">
						<p><span>You can not leave this project</span></p>
					</div>
					<hr>
					<div>
						<p><span> Sorry! You can not leave this project by yourself. Please request your project admin remove you out of project if you like so. 
						</span></p>
