	...
	<div id="container">
		...
		<div id="body" style="background-color: rgb(239, 239, 239); width: 100%;">
			...
			<div style="padding-left: 300px; padding-right: 250px; background-color: rgb(239, 239, 239); height: 100%;">
				<div id="mainBody">
					<div id="title">
						<p><span>User not exist</span></p>
					</div>
					<hr>
					<div>
						<p><span>Sorry! This account does not exist in the system. Please enter the registered email to be able to receive the information helping you to recover the password.
						</span></p>
