	...
	<div id="container">
		...
		<div id="body" style="background-color: rgb(239, 239, 239); width: 100%;">
			...
			<div style="padding-left: 300px; padding-right: 250px; background-color: rgb(239, 239, 239); height: 100%;">
				<div id="mainBody">
					<div id="title">
						<p><span>User not active</span></p>
					</div>
					<hr>
					<div>
						<p><span>Sorry! Your account has not been activated yet. Please click on the link in the email we sent to activate or you can contact our Customer Support team for assistance.
						</span></p>
