...
<body>
	<table width="650" cellpadding="0" cellspacing="0" border="0" style="margin: 0px auto;">
		...
		<tr>
			<td style="background: url('${defaultUrls.cdn_url}border_large_center_blue.png') repeat-y 0 0 transparent; text-align: center; padding-bottom: 10px;"><span style="font: bold 18px Tahoma, Geneva, sans-serif;text-transform: uppercase; color: white;">New comment created</span>
			</td>
		</tr>
		<tr>
			<td style="background: url('${defaultUrls.cdn_url}border_large_center_white.png') repeat-y 0 0 transparent; color: #4e4e4e; font: 14px 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; padding: 32px 32px 0px;">
				...
				<p style="line-height: 28px;">Just wanna let you know that a new new comment has been created by <a href="$userComment" style="color: #4283c4; text-decoration: underline;">$comment.changeByUserFullName</a> to the task <a href="$hyperLinks.taskUrl" style="color: #4283c4; text-decoration: underline;">$hyperLinks.shortTaskUrl</a> in task list <a href="$hyperLinks.taskListUrl" style="color: #4283c4; text-decoration: underline;">$task.taskListName</a> and in project <a href="$hyperLinks.projectUrl" style="color: #4283c4; text-decoration: underline;">$task.projectName</a>. Here're details about it:</p>
