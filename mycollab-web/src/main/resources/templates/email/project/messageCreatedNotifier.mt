...
<body>
	<table width="650" cellpadding="0" cellspacing="0" border="0" style="margin: 0px auto;">
		...
		<tr>
			<td style="background: url('${defaultUrls.cdn_url}border_large_center_blue.png') repeat-y 0 0 transparent; text-align: center; padding-bottom: 10px;"><span style="font: bold 18px Tahoma, Geneva, sans-serif;text-transform: uppercase; color: white;">New message created</span>
			</td>
		</tr>
		<tr>
			<td style="background: url('${defaultUrls.cdn_url}border_large_center_white.png') repeat-y 0 0 transparent; color: #4e4e4e; font: 14px 'Lucida Sans Unicode', 'Lucida Grande', sans-serif; padding: 32px 32px 0px;">
				...
				<p style="line-height: 28px;">Just wanna let you know that a new new message has been created by <a href="$hyperLinks.createdUserUrl" style="color: #4283c4; text-decoration: underline;">$message.fullPostedUserName</a> in project <a href="$hyperLinks.projectUrl" style="color: #4283c4; text-decoration: underline;">$message.projectName</a>. Here're details about it:</p>
