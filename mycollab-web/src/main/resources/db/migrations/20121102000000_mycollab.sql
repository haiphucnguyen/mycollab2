...
INSERT INTO `s_user` VALUES ('user1','a1',NULL,'b1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL),('user2','a2',NULL,'b2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL);
...
CREATE TABLE `m_prj_task` (
  ...
  CONSTRAINT `FK_m_prj_task_3` FOREIGN KEY (`tasklistid`) REFERENCES `m_prj_task_list` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-12-07 13:21:07
-- MySQL dump 10.13  Distrib 5.5.24, for osx10.5 (i386)
--
-- Host: localhost    Database: mycollab_live
-- ------------------------------------------------------
-- Server version	5.5.27
