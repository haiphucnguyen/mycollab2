...
public class MyCollabServlet extends ICEPushServlet {
	...
	protected void writeAjaxPageHtmlHeader(BufferedWriter page, String title,
		...
		page.append("<script type=\"text/javascript\" src=\"https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js\"/>");
		page.append("<script type=\"text/javascript\" src=\"https://s3.amazonaws.com/mycollab_assets/assets/js/stickytooltip.js\"/>");
	}
