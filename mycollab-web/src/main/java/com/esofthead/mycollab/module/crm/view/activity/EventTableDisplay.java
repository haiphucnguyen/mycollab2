 ...
 */
public class EventTableDisplay extends PagedBeanTable2<EventService, EventSearchCriteria, SimpleEvent> {

    public EventTableDisplay(final String[] visibleColumns, String[] columnHeaders) {
        super(AppContext.getSpringBean(EventService.class),
                SimpleEvent.class, visibleColumns, columnHeaders);
        ...
        this.addGeneratedColumn("selected", new Table.ColumnGenerator() {
            ...
            public Object generateCell(final Table source, final Object itemId,
                ...
                SimpleEvent simpleEvent = EventTableDisplay.this.getBeanByIndex(itemId);
        ...
        this.addGeneratedColumn("startDate", new Table.ColumnGenerator() {
            ...
            public com.vaadin.ui.Component generateCell(Table source,
                ...
                final SimpleEvent event = EventTableDisplay.this.getBeanByIndex(itemId);
                Label l = new Label();
