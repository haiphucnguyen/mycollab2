...
public class TaskDefaultFormLayoutFactory {
    ...
    static {
        ...
        mainSection.addField(new TextDynaFieldBuilder().fieldName(Task.Field.tasklistid).required(true)
                .displayName(AppContext.getMessage(TaskI18nEnum.FORM_TASKGROUP))
                .fieldIndex(8).build());
