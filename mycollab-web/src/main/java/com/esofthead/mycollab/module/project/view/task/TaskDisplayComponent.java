...
public class TaskDisplayComponent extends CssLayout {
	...
	private static class SimpleTaskDisplay extends VerticalLayout implements
			TaskDisplayLayout {
		private final TaskRowDisplayHandler taskRowHandler;
	...
	private static class AdvancedTaskDisplay extends VerticalLayout implements
			TaskDisplayLayout {
		private final TaskRowDisplayHandler taskRowHandler;
		...
		public void showTask(final SimpleTask task) {
			...
			Button moreButton = new Button("Less ...",
					new Button.ClickListener() {
