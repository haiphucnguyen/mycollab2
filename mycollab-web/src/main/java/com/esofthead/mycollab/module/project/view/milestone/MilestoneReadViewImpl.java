...
public class MilestoneReadViewImpl extends
	...
	public MilestoneReadViewImpl() {
		super(AppContext.getMessage(Project18nEnum.VIEW_DETAIL_TITLE),
	...
	protected ComponentContainer createBottomPanel() {
		...
		tabContainer.addTab(this.associateTaskGroupListComp,
				AppContext.getMessage(Project18nEnum.TAB_RELATED_TASKS),
		...
		public void attachField(final Object propertyId, final Field<?> field) {
			if (propertyId.equals("startdate")) {
				this.informationLayout.addComponent(field, AppContext
						.getMessage(Project18nEnum.FORM_START_DATE_FIELD),
						0, 0);
			} else if (propertyId.equals("enddate")) {
				this.informationLayout.addComponent(field, AppContext
						.getMessage(Project18nEnum.FORM_END_DATE_FIELD), 0,
						1);
				...
				this.informationLayout.addComponent(field, AppContext
						.getMessage(Project18nEnum.FORM_STATUS_FIELD), 1, 1);
			} else if (propertyId.equals("numOpenTasks")) {
				this.informationLayout.addComponent(field, AppContext
						.getMessage(Project18nEnum.FORM_TASK_FIELD), 0, 2);
			} else if (propertyId.equals("numOpenBugs")) {
				this.informationLayout
						.addComponent(field, AppContext
								.getMessage(Project18nEnum.FORM_BUG_FIELD),
								1, 2);
