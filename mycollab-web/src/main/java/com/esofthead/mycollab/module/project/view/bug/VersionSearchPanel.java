 ...
 */
public class VersionSearchPanel  extends GenericSearchPanel<VersionSearchCriteria> {
    ...
    public VersionSearchPanel() {
        this.project = (SimpleProject) AppContext.getVariable(ProjectContants.PROJECT_NAME);
    }
    ...
    private class VersionBasicSearchCriteria extends GenericSearchPanel.BasicSearchLayout {
            ...
            Button searchBtn = new Button("Search",
                    new Button.ClickListener() {
                        ...
                        public void buttonClick(Button.ClickEvent event) {
                            ...
                            searchCriteria.setVersionname(new StringSearchField(nameField.getValue().toString().trim()));
                            
                            VersionSearchPanel.this
