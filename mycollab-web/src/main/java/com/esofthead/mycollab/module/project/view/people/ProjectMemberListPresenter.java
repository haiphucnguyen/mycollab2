 ...
 */
public class ProjectMemberListPresenter extends AbstractPresenter<ProjectMemberListView> implements
    ...
    public ProjectMemberListPresenter() {
        ...
        projectMemberService = AppContext.getSpringBean(ProjectMemberService.class);
    ...
    private void selectAllItemsInCurrentPage() {
        Collection<SimpleProjectMember> currentDataList = view.getPagedBeanTable()
                .getCurrentDataList();
        for (SimpleProjectMember item : currentDataList) {
    ...
    protected void onGo(ComponentContainer container, ScreenData<?> data) {
        ProjectMemberContainer projectMemberContainer = (ProjectMemberContainer) container;
