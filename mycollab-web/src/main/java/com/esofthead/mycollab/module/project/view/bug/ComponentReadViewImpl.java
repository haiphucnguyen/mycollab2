...
public class ComponentReadViewImpl extends AbstractView implements
    ...
    protected class ComponentFormFieldLayout extends DefaultFormViewFieldFactory {
    ...
    private class PreviewForm extends AdvancedPreviewBeanForm<SimpleComponent> {
        ...
        class FormLayoutFactory extends ComponentFormLayoutFactory implements IBugReportDisplayContainer {
            ...
            public void displayBugReports() {
                ...
                unresolvedByPrioritySearchCriteria.setComponentids(new SetSearchField<Integer>(component.getId()));
