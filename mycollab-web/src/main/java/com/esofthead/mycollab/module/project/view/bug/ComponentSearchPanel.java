...
public class ComponentSearchPanel extends GenericSearchPanel<ComponentSearchCriteria> {
    ...
    private class ComponentBasicSearchCriteria extends GenericSearchPanel.BasicSearchLayout {
            ...
            Button searchBtn = new Button("Search",
                    new Button.ClickListener() {
                        ...
                        public void buttonClick(Button.ClickEvent event) {
                            ...
                            searchCriteria.setComponentName(new StringSearchField(nameField.getValue().toString().trim()));
                            
                            ComponentSearchPanel.this
