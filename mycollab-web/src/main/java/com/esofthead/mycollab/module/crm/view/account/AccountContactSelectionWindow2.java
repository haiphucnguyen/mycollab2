...
public class AccountContactSelectionWindow2 extends
RelatedItemSelectionWindow2<SimpleContact, ContactSearchCriteria> {

	public AccountContactSelectionWindow2(
			final AccountContactListComp2 associateContactList) {
	...
	protected void initUI() {
		...
		final Button selectBtn = new Button("Select",
			...
			public void buttonClick(final ClickEvent event) {
				AccountContactSelectionWindow2.this.close();
			}
		});
		...
		.addSearchHandler(new SearchHandler<ContactSearchCriteria>() {
			...
			public void onSearch(final ContactSearchCriteria criteria) {
				AccountContactSelectionWindow2.this.tableItem
