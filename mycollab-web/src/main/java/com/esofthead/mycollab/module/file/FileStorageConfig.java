...
public class FileStorageConfig {
	...
	public static File getAvatarFile(int accountId, String username, int size) {
		File userAvatarFile = new File(baseContentFolder, accountId
				+ "/avatar/" + username + "_" + size + ".png");
