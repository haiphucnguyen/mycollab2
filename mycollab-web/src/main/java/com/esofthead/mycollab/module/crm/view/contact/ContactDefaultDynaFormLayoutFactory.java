...
public class ContactDefaultDynaFormLayoutFactory {
    ...
    static {
        ...
        contactSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.firstname)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_FIRSTNAME))
                .fieldIndex(0).build());

        contactSection.addFields(new PhoneDynaFieldBuilder().fieldName(Contact.Field.officephone)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_OFFICE_PHONE))
                .fieldIndex(1).build());

        contactSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.lastname)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_LASTNAME))
                .fieldIndex(2).mandatory(true).build());

        contactSection.addFields(new PhoneDynaFieldBuilder().fieldName(Contact.Field.mobile)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_MOBILE))
                .fieldIndex(3).build());

        contactSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.accountid)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_ACCOUNTS))
                .fieldIndex(4).build());

        contactSection.addFields(new PhoneDynaFieldBuilder().fieldName(Contact.Field.homephone)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_HOME_PHONE))
                .fieldIndex(5).build());

        contactSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.title)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_TITLE))
                .fieldIndex(6).build());

        contactSection.addFields(new PhoneDynaFieldBuilder().fieldName(Contact.Field.otherphone)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_OTHER_PHONE))
                .fieldIndex(7).build());

        contactSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.department)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_DEPARTMENT))
                .fieldIndex(8).build());

        contactSection.addFields(new PhoneDynaFieldBuilder().fieldName(Contact.Field.fax)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_FAX))
                .fieldIndex(9).build());

        contactSection.addFields(new EmailDynaFieldBuilder().fieldName(Contact.Field.email)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_EMAIL))
                .fieldIndex(10).build());

        contactSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.birthday)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_BIRTHDAY))
                .fieldIndex(11).build());

        contactSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.assistant)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_ASSISTANT))
                .fieldIndex(12).build());

        contactSection.addFields(new BooleanDynaFieldBuilder().fieldName(Contact.Field.iscallable)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_IS_CALLABLE))
                .fieldIndex(13).build());

        contactSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.assistantphone)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_ASSISTANT_PHONE))
                .fieldIndex(14).build());

        contactSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.assignuser)
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_ASSIGNEE))
                .fieldIndex(15).build());

        contactSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.leadsource)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_LEAD_SOURCE))
                .fieldIndex(16).build());

        defaultForm.addSections(contactSection);
        ...
        addressSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.primaddress)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_PRIMARY_ADDRESS))
                .fieldIndex(0).build());

        addressSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.otheraddress)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_OTHER_ADDRESS))
                .fieldIndex(1).build());

        addressSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.primcity)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_PRIMARY_CITY))
                .fieldIndex(2).build());

        addressSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.othercity)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_OTHER_CITY))
                .fieldIndex(3).build());

        addressSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.primstate)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_PRIMARY_STATE))
                .fieldIndex(4).build());

        addressSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.otherstate)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_OTHER_STATE))
                .fieldIndex(5).build());

        addressSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.primpostalcode)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_PRIMARY_POSTAL_CODE))
                .fieldIndex(6).build());

        addressSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.otherpostalcode)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_OTHER_POSTAL_CODE))
                .fieldIndex(7).build());

        addressSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.primcountry)
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_PRIMARY_COUNTRY))
                .fieldIndex(8).build());

        addressSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.othercountry)
        ...
        descSection.addFields(new TextDynaFieldBuilder().fieldName(Contact.Field.description)
