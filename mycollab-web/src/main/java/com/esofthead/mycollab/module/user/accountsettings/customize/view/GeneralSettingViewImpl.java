...
public class GeneralSettingViewImpl extends AbstractPageView implements GeneralSettingView {
    ...
    public void displayView() {
        ...
        gridFormLayoutHelper.addComponent(new Label(TimezoneMapper.getTimezoneExt(billingAccount.getDefaulttimezone())
                .getDisplayName(AppContext.getUserLocale())), AppContext.getMessage(AdminI18nEnum.FORM_DEFAULT_TIMEZONE), 0, 2);
