...
public class MilestoneListViewImpl extends AbstractView implements
	...
	private ComponentContainer constructMilestoneBox(
		...
		Label buttonLink = new Label(milestone.getOwnerFullName());
		// buttonLink.setIcon(UserAvatarControlFactory.createAvatarResource(
		// milestone.getOwnerAvatarId(), 16));
		layoutHelper.addComponent(buttonLink, "Assignee", 0, 2,
				Alignment.MIDDLE_LEFT);
