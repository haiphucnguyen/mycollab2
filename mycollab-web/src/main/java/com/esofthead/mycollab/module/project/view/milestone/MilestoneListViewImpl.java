...
public class MilestoneListViewImpl extends AbstractLazyPageView implements
	...
	private void initUI() {
		...
		Label headerText = new Label(
				AppContext.getMessage(Project18nEnum.VIEW_LIST_TITLE));
	...
	private void constructBody() {
		...
		final Label closedHeader = new Label(
				AppContext
						.getMessage(Project18nEnum.WIDGET_CLOSED_PHASE_TITLE));
		...
		final Label inProgressHeader = new Label(
				AppContext
						.getMessage(Project18nEnum.WIDGET_INPROGRESS_PHASE_TITLE));
		...
		final Label futureHeader = new Label(
				AppContext
						.getMessage(Project18nEnum.WIDGET_FUTURE_PHASE_TITLE));
	...
	private ComponentContainer constructMilestoneBox(
		...
		layoutHelper.addComponent(
				...
				AppContext.getMessage(Project18nEnum.FORM_START_DATE_FIELD),
				0, 0, Alignment.MIDDLE_LEFT);
		layoutHelper.addComponent(
				new Label(AppContext.formatDate(milestone.getEnddate(),
						AppContext.getMessage(GenericI18Enum.FORM_EMPTY))),
				AppContext.getMessage(Project18nEnum.FORM_END_DATE_FIELD),
		...
		layoutHelper.addComponent(progressTask,
				AppContext.getMessage(Project18nEnum.FORM_TASK_FIELD), 0, 3,
				Alignment.MIDDLE_LEFT);
		...
		layoutHelper.addComponent(progressBug,
				AppContext.getMessage(Project18nEnum.FORM_BUG_FIELD), 0, 4,
				Alignment.MIDDLE_LEFT);
