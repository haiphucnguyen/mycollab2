...
public class CampaignDefaultDynaFormLayoutFactory {
    ...
    static {
        ...
        campaignSection.addFields(new TextDynaFieldBuilder().fieldName("campaignname")
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_NAME))
                .mandatory(true).fieldIndex(0).build());

        campaignSection.addFields(new TextDynaFieldBuilder().fieldName("status")
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_STATUS))
                .fieldIndex(1).build());

        campaignSection.addFields(new DateDynaFieldBuilder().fieldName("startdate")
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_START_DATE))
                .fieldIndex(2).build());

        campaignSection.addFields(new TextDynaFieldBuilder().fieldName("type")
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_TYPE))
                .fieldIndex(3).build());

        campaignSection.addFields(new DateDynaFieldBuilder().fieldName("enddate")
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_END_DATE))
                .fieldIndex(4).build());

        campaignSection.addFields(new TextDynaFieldBuilder().fieldName("assignuser")
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_ASSIGNEE))
                .fieldIndex(5).build());

        defaultForm.addSections(campaignSection);
        ...
        goalSection.addFields(new CurrencyDynaFieldBuilder().fieldName("currencyid")
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_CURRENCY))
                .fieldIndex(0).build());

        goalSection.addFields(new NumberDynaFieldBuilder().fieldName("expectedcost")
                .displayName(AppContext.getMessage(CampaignI18nEnum.FORM_EXPECTED_COST))
                .fieldIndex(2).build());

        goalSection.addFields(new NumberDynaFieldBuilder().fieldName("budget")
                .displayName(AppContext.getMessage(CampaignI18nEnum.FORM_BUDGET))
                .fieldIndex(3).build());

        goalSection.addFields(new NumberDynaFieldBuilder().fieldName("expectedrevenue")
                .displayName(AppContext.getMessage(CampaignI18nEnum.FORM_EXPECTED_REVENUE))
                .fieldIndex(4).build());

        goalSection.addFields(new NumberDynaFieldBuilder().fieldName("actualcost")
                .displayName(AppContext.getMessage(CampaignI18nEnum.FORM_ACTUAL_COST))
                .fieldIndex(5).build());

        defaultForm.addSections(goalSection);
