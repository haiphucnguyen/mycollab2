 ...
 */
public class OpportunityContactListComp extends RelatedListComp<SimpleContact, ContactSearchCriteria> {
            ...
            public void handle(TableClickEvent event) {
                ...
                if ("contactName".equals(event.getFieldName())) {
                    EventBus.getInstance().fireEvent(
                            ...
                            OpportunityContactListComp.this, contact
                            .getId()));
                }
            }
        });
                        ...
                        ConfirmDialog.show(AppContext.getApplication().getMainWindow(),
                            ...
                            public void onClose(ConfirmDialog dialog) {
                                if (dialog.isConfirmed()) {
                                    ...
                                    opportunityService.removeOpportunityContactRelationship(associateContact);
