...
public class CallReadViewImpl extends AbstractView implements CallReadView {
	...
	@Override
	public void previewItem(SimpleCall campaign) {
		this.call = campaign;
		previewForm.setItemDataSource(new BeanItem<Call>(campaign));
	}
	...
	private static class PreviewForm extends AdvancedPreviewBeanForm<SimpleCall> {
		private static final long serialVersionUID = 1L;
