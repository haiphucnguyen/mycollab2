 ...
 */
public class LeadCampaignListComp  extends RelatedListComp<SimpleCampaign, CampaignSearchCriteria> {
    ...
    private void loadCampaigns() {
        ...
        criteria.setLeadId(new NumberSearchField(SearchField.AND, lead
                .getId()));
    ...
    private void initUI() {
        ...
        tableItem = new CampaignTableDisplay(
                new String[]{"campaignname", "status", "type", "startdate", "id"},
                new String[]{"Name", "Status", "Type", "Start Date", "Action"});
        ...
        tableItem.addGeneratedColumn("id", new Table.ColumnGenerator() {
            ...
            public Object generateCell(Table source, Object itemId,
                    Object columnId) {
                final SimpleCampaign campaign = (SimpleCampaign) tableItem.getBeanByIndex(itemId);
                        ...
                        ConfirmDialog.show(AppContext.getApplication().getMainWindow(),
                            ...
                            public void onClose(ConfirmDialog dialog) {
                                if (dialog.isConfirmed()) {
                                    ...
                                    associateLead.setLeadid(campaign.getId());
