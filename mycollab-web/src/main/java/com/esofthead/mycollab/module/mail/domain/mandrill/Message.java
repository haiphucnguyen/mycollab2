...
public class Message {
	...
	/**
	 * @param preserve_recipients
	 *            the preserve_recipients to set
	 */
	...
	public Message() {
		String fromMailTemplate = MailConfig
				.getProperty(MailConfig.FROM_TEMPLATE);
		if (null != fromMailTemplate && fromMailTemplate.length() > 0) {
			String key = EncryptText.encryptText(String.valueOf(System
					.currentTimeMillis()));
			from_email = String.format(fromMailTemplate, key);
		}
