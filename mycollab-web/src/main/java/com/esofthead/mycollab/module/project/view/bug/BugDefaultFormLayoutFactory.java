...
public class BugDefaultFormLayoutFactory {
    public static DynaForm getForm() {
        ...
        //Row 1
        mainSection.addFields(new TextDynaFieldBuilder().fieldName(BugWithBLOBs.Field.summary)
        ...
        mainSection.addFields(new TextDynaFieldBuilder().fieldName(BugWithBLOBs.Field.assignuser)
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_ASSIGNEE))
                .fieldIndex(2).build());

        //Row 3
        mainSection.addFields(new TextDynaFieldBuilder().fieldName(BugWithBLOBs.Field.severity)
                .displayName(AppContext.getMessage(BugI18nEnum.FORM_SEVERITY))
                .fieldIndex(3).build());

        mainSection.addFields(new TextDynaFieldBuilder().fieldName(SimpleBug.Field.components)
        ...
        //Row 4
        mainSection.addFields(new TextDynaFieldBuilder().fieldName(BugWithBLOBs.Field.startdate)
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_START_DATE)).fieldIndex(5).build());

        mainSection.addFields(new TextDynaFieldBuilder().fieldName(SimpleBug.Field.affectedVersions)
        ...
        mainSection.addFields(new TextDynaFieldBuilder().fieldName(BugWithBLOBs.Field.enddate)
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_END_DATE))
                .fieldIndex(7).build());

        mainSection.addFields(new TextDynaFieldBuilder().fieldName(SimpleBug.Field.fixedVersions)
        ...
        //Row 5
        mainSection.addFields(new TextDynaFieldBuilder().fieldName(BugWithBLOBs.Field.duedate)
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_DUE_DATE))
                .fieldIndex(9).build());

        mainSection.addFields(new TextDynaFieldBuilder().fieldName(BugWithBLOBs.Field.milestoneid)
                .displayName(AppContext.getMessage(BugI18nEnum.FORM_PHASE))
                .fieldIndex(10).build());

        mainSection.addFields(new TextDynaFieldBuilder().fieldName(BugWithBLOBs.Field.estimatetime)
        ...
        mainSection.addFields(new TextDynaFieldBuilder().fieldName(BugWithBLOBs.Field.estimateremaintime)
        ...
        mainSection.addFields(new TextDynaFieldBuilder().fieldName(BugWithBLOBs.Field.environment)
                .displayName(AppContext.getMessage(BugI18nEnum.FORM_ENVIRONMENT))
                .fieldIndex(13).colSpan(true).build());

        mainSection.addFields(new TextDynaFieldBuilder().fieldName(BugWithBLOBs.Field.description)
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_DESCRIPTION))
                .fieldIndex(14).colSpan(true).build());

        mainSection.addFields(new TextDynaFieldBuilder().fieldName(BugWithBLOBs.Field.id)
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_ATTACHMENTS))
                .fieldIndex(15).colSpan(true).build());

        mainSection.addFields(new TextDynaFieldBuilder().fieldName(SimpleBug.Field.selected)
