 ...
 * <h4>Prerequisites</h4>
 * <p>
 * These instructions work well in a J2EE environment. Feel free to tweak in
 * order to fit your own needs.
 * </p>
 * <ul>
...
public class VelocityEmail extends HtmlEmail {
	 ...
	 * 
	 * @param context
	 *            The Velocity context to be merged
	 * @throws EmailException
	 */
	public void setHtmlMsg(VelocityContext context) throws EmailException {
		try {
			...
			Velocity.mergeTemplate(templateFile,
					RuntimeConstants.ENCODING_DEFAULT, context, writer);
