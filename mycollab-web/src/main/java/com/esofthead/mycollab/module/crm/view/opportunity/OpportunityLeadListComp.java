 ...
 */
public class OpportunityLeadListComp extends RelatedListComp<SimpleLead, LeadSearchCriteria> {
    ...
    public void displayLeads(Opportunity opportunity) {
    ...
    private void initUI() {
        ...
        Button selectBtn = new Button("Select from existing leads", new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent event) {
                OpportunityLeadSelectionWindow leadsWindow = new OpportunityLeadSelectionWindow(OpportunityLeadListComp.this);
                LeadSearchCriteria criteria = new LeadSearchCriteria();
            ...
            public void handle(TableClickEvent event) {
                ...
                if ("leadName".equals(event.getFieldName())) {
                    EventBus.getInstance().fireEvent(
                            ...
                            OpportunityLeadListComp.this, lead
                            .getId()));
                }
            }
        });
                        ...
                        ConfirmDialog.show(AppContext.getApplication().getMainWindow(),
                            ...
                            public void onClose(ConfirmDialog dialog) {
                                if (dialog.isConfirmed()) {
                                    ...
                                    opportunityService.removeOpportunityLeadRelationship(associateLead);
