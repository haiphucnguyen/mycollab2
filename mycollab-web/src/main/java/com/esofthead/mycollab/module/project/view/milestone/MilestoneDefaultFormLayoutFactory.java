...
public class MilestoneDefaultFormLayoutFactory {
    ...
    static {
        ...
        mainSection.addFields(new TextDynaFieldBuilder().fieldName(Milestone.Field.name).displayName(AppContext
                .getMessage(GenericI18Enum.FORM_NAME)).fieldIndex(0).mandatory(true).required(true).colSpan(true).build());

        mainSection.addFields(new TextDynaFieldBuilder().fieldName(Milestone.Field.startdate).displayName(AppContext
                .getMessage(GenericI18Enum.FORM_START_DATE)).fieldIndex(1).build());

        mainSection.addFields(new TextDynaFieldBuilder().fieldName(Milestone.Field.enddate).displayName(AppContext
                .getMessage(GenericI18Enum.FORM_END_DATE)).fieldIndex(2).build());

        mainSection.addFields(new TextDynaFieldBuilder().fieldName(Milestone.Field.owner).displayName(AppContext
                .getMessage(GenericI18Enum.FORM_ASSIGNEE)).fieldIndex(3)
                .build());

        mainSection.addFields(new TextDynaFieldBuilder().fieldName(Milestone.Field.status).displayName(AppContext
        ...
        mainSection.addFields(new TextDynaFieldBuilder().fieldName(Milestone.Field.description).displayName(AppContext
                .getMessage(GenericI18Enum.FORM_DESCRIPTION)).fieldIndex(5).colSpan(true).build());

        mainSection.addFields(new TextDynaFieldBuilder().fieldName(Milestone.Field.id).displayName(AppContext
                .getMessage(MilestoneI18nEnum.FORM_ASSIGNMENTS)).fieldIndex(6).colSpan(true).build());

        mainSection.addFields(new TextDynaFieldBuilder().fieldName(Milestone.Field.saccountid).displayName(AppContext
