 ...
 */
public class ComponentListPresenter extends AbstractPresenter<ComponentListView> implements
        ListPresenter<ComponentSearchCriteria> {

    private static final long serialVersionUID = 1L;
    private static final String[] EXPORT_VISIBLE_COLUMNS = new String[]{"componentname", "description"};
