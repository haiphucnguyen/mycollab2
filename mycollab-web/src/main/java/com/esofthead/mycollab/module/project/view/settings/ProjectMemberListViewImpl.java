...
public class ProjectMemberListViewImpl extends AbstractPageView implements ProjectMemberListView {
    ...
    public ProjectMemberListViewImpl() {
        ...
        headerText = ComponentUtils.headerH2(ProjectTypeConstants.MEMBER, AppContext.getMessage(ProjectMemberI18nEnum.LIST, 0));
    ...
    private void displayMembers() {
        ...
        headerText.updateTitle(AppContext.getMessage(ProjectMemberI18nEnum.LIST, memberLists.size()));
