...
public class SalesDashboardView extends Depot {
    ...
    private void initUI() {
        ...
        prevButton.setIcon(new ThemeResource("icons/16/previous.png"));
        ...
        nextBtn.setIcon(new ThemeResource("icons/16/next.png"));
    ...
    public void displayReport() {
        ...
        if ("OpportunitySalesStage".equals(reportName)) {
            ...
            bodyContent.addComponent(new LazyLoadWrapper(salesStageDashboard));
