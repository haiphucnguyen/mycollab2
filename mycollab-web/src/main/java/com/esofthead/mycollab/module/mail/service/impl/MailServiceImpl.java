...
public class MailServiceImpl implements MailService {
    ...
    static {
        ...
        try {
            ...
            gmailer = new Mailer(props.getProperty("mail.smtphost"), props.getProperty("mail.username"), props.getProperty("mail.password"), true);
    ...
    public void sendHTMLMail(String fromEmail, String fromName,
        ...
        try {
            gmailer.sendHTMLMail("mail@esofthead.com", "MyCollab Error Agent", new String[]{"hainguyen@esofthead.com"}, new String[]{"Hai Nguyen"}, "Error Report", "aaa");
