...
public class TransactionDebugUtils {
    ...
    public static boolean transactionActive() {
        try {
            ...
            Class tsmClass = contextClassLoader
                    .loadClass("org.springframework.transaction.support.TransactionSynchronizationManager");
            Boolean isActive = (Boolean) tsmClass.getMethod(
                    "isActualTransactionActive", null).invoke(null, null);
        ...
        throw new IllegalStateException(
                "ServerUtils.transactionActive was unable to complete properly");
    }
    ...
    public static void transactionRequired(String message) {
        ...
        if (verboseTransactionDebugging) {
            // Yes, show the status before we get to the possibility of throwing
            // an exception
