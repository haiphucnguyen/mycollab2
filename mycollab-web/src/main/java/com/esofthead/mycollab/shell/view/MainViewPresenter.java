...
public class MainViewPresenter extends AbstractPresenter<MainView> {
    ...
    protected void onGo(ComponentContainer container, ScreenData<?> data) {
        ...
        if (pref.getLastmodulevisit() == null || ModuleNameConstants.CRM.equals(pref.getLastmodulevisit())) {
            //go to crm module
            ...
            log.debug("Do not support navigate to module: " + pref.getLastmodulevisit());
        }
    }
}
