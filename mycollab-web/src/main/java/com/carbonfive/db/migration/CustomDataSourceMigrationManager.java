...
public class CustomDataSourceMigrationManager extends
	...
	public CustomDataSourceMigrationManager(DataSource dataSource) {
		...
		switch (type) {
		case H2:
			setMigrationResolver(new ResourceMigrationResolver(H2_MIGRATION_LOCATION));
			break;
		default:
			setMigrationResolver(new ResourceMigrationResolver(DEFAULT_MIGRATIONS_LOCATION));
			break;
		}
	}
