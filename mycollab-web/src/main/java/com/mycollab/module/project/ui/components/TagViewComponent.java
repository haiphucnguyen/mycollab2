...
public class TagViewComponent extends CssLayout {
    ...
    public void display(String type, int typeId) {
        ...
        List<Tag> tags = tagService.findTags(type, typeId + "", UserUIContext.getAccountId());
        for (Tag tag : tags) {
    ...
    private HorizontalLayout createSaveTagComp() {
        ...
        MButton addBtn = new MButton(UserUIContext.getMessage(GenericI18Enum.BUTTON_ADD), clickEvent -> {
            ...
            if (!tagName.equals("")) {
                ...
                tag.setSaccountid(UserUIContext.getAccountId());
                    ...
                    ConfirmDialogExt.show(UI.getCurrent(),
                            ...
                            confirmDialog -> {
                                if (confirmDialog.isConfirmed()) {
                                    tagService.removeWithSession(tag, UserUIContext.getUsername(), UserUIContext.getAccountId());
