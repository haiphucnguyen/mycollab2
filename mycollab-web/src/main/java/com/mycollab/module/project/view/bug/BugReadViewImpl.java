...
import com.mycollab.module.project.view.bug.components.LinkIssueWindow;
import com.mycollab.module.project.view.bug.components.ToggleBugSummaryField;
import com.mycollab.module.project.view.bug.components.ToggleBugSummaryWithDependentField;
    ...
    private ApplicationEventListener<BugEvent.BugChanged> bugChangedHandler = new
            ApplicationEventListener<BugEvent.BugChanged>() {
                ...
                public void handle(BugEvent.BugChanged event) {
                    ...
                    SimpleBug bugChange = bugService.findById(bugChangeId, UserUIContext.getAccountId());
