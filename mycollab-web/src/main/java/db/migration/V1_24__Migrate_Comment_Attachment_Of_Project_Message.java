...
public class V1_24__Migrate_Comment_Attachment_Of_Project_Message implements
		SpringJdbcMigration {

	private static Logger log = LoggerFactory
			.getLogger(V1_24__Migrate_Comment_Attachment_Of_Project_Message.class);

	public void migrate(JdbcTemplate jdbcTemplate) throws Exception {
		try {

			List<Record> comments = jdbcTemplate
					.query("select m_comment.*, m_prj_message.projectid from m_comment,  m_prj_message WHERE m_comment.type=\"Project-Message\" AND m_prj_message.id=m_comment.typeid",
