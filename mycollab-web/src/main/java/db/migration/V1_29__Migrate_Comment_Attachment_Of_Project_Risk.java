...
public class V1_29__Migrate_Comment_Attachment_Of_Project_Risk implements
		SpringJdbcMigration {

	private static Logger log = LoggerFactory
			.getLogger(V1_29__Migrate_Comment_Attachment_Of_Project_Risk.class);

	public void migrate(JdbcTemplate jdbcTemplate) throws Exception {
		try {

			List<Record> comments = jdbcTemplate
					.query("select m_comment.*, m_prj_risk.projectid from m_comment,  m_prj_risk WHERE m_comment.type=\"Project-Risk\" AND m_prj_risk.id=m_comment.typeid",
