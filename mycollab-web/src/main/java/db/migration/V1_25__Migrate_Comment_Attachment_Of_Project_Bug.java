...
public class V1_25__Migrate_Comment_Attachment_Of_Project_Bug implements
		SpringJdbcMigration {

	private static Logger log = LoggerFactory
			.getLogger(V1_25__Migrate_Comment_Attachment_Of_Project_Bug.class);

	public void migrate(JdbcTemplate jdbcTemplate) throws Exception {
		try {

			List<Record> comments = jdbcTemplate
					.query("select m_comment.*, m_tracker_bug.projectid from m_comment,  m_tracker_bug WHERE m_comment.type=\"Project-Bug\" AND m_tracker_bug.id=m_comment.typeid",
