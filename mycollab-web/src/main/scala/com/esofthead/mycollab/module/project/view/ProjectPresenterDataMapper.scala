...
object ProjectPresenterDataMapper {
  ...
  val projectMapper = Map[Class[_ <: ScreenData[_]], Class[_ <: IPresenter[_]]](
    ...
    classOf[ProjectScreenData.GotoGanttChart] -> classOf[UserProjectDashboardPresenter],
    classOf[ProjectScreenData.GotoCalendarView] -> classOf[UserProjectDashboardPresenter],
