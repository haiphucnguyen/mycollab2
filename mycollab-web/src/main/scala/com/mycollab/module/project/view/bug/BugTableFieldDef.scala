...
import com.mycollab.module.project.i18n.{BugI18nEnum, TimeTrackingI18nEnum}
...
object BugTableFieldDef {
  ...
  val milestoneName = new TableViewField(BugI18nEnum.FORM_PHASE, "milestoneName", WebUIConstants.TABLE_X_LABEL_WIDTH)
