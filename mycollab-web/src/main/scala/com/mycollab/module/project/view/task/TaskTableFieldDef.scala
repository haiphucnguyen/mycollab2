...
object TaskTableFieldDef {
  ...
  val taskname = new TableViewField(GenericI18Enum.FORM_NAME, "taskname", WebUIConstants.TABLE_X_LABEL_WIDTH)
  val note = new TableViewField(TaskI18nEnum.FORM_NOTES, "notes", WebUIConstants.TABLE_EX_LABEL_WIDTH)
