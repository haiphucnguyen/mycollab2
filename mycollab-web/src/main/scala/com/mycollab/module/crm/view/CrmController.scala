...
import com.mycollab.module.crm.view.cases.{CaseAddPresenter, CaseListPresenter, CaseReadPresenter}
import com.mycollab.module.crm.view.contact.{ContactAddPresenter, ContactListPresenter, ContactReadPresenter}
import com.mycollab.module.crm.view.file.FileDashboardPresenter
import com.mycollab.module.crm.view.lead.{LeadAddPresenter, LeadConvertReadPresenter, LeadListPresenter, LeadReadPresenter}
import com.mycollab.module.crm.view.opportunity.{ContactRoleEditPresenter, OpportunityAddPresenter, OpportunityListPresenter, OpportunityReadPresenter}
import com.mycollab.module.crm.view.parameters.{ActivityScreenData, AssignmentScreenData, CallScreenData, MeetingScreenData}
import com.mycollab.module.crm.view.setting.CrmSettingPresenter
import com.mycollab.vaadin.mvp.{AbstractController, PresenterResolver, ScreenData}
    ...
    this.register(new ApplicationEventListener[LeadEvent.GotoRead]() {
      ...
      @SuppressWarnings(Array("unchecked", "rawtypes")) def handle(event: LeadEvent.GotoRead) {
        ...
        if (value.isInstanceOf[Integer]) {
          ...
          lead = leadService.findById(value.asInstanceOf[Integer], UserUIContext.getAccountId)
        }
