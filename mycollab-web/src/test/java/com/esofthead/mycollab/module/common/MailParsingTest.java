...
public class MailParsingTest {
	...
	public void testValidEmail5() throws InvalidEmailException {
		...
		List<MailRecipientField> emailFields = ParsingUtils
				.parseEmailField(validEmails);
		for (MailRecipientField temp : emailFields) {
			System.out.println("email: " + temp.getEmail());
		}
		Assert.assertEquals(3, emailFields.size());
	}
	
	private static final String[] VALID_SINGLE_EMAIL = new String[]  { "mkyong@yahoo.com",
	...
	private static final String[] INVALID_SINGLE_EMAIL = new String[] { "mkyong", "mkyong@.com.my",
