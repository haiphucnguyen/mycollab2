 ...
 * @since 4.5.0
 */
public class ProjectMemberSelectionView extends
		AbstractSelectionView<SimpleProjectMember> {
	...
	public ProjectMemberSelectionView() {
		...
		this.setCaption(AppContext
				.getMessage(ProjectMemberI18nEnum.M_VIEW_MEMBER_LOOKUP));
	}
	...
	public void load() {
		...
		memberListDisplay.getListContainer().addComponentAsFirst(
				rowDisplayHandler.generateRow(blankMember, 0));
	}

	private class MemberRowDisplayHandler implements
			...
			mainLayout
					.addLayoutClickListener(new LayoutEvents.LayoutClickListener() {
						...
						public void layoutClick(
							...
							ProjectMemberSelectionView.this
