...
public class InsideProjectNavigationMenu extends AbstractNavigationMenu {
    ...
    public InsideProjectNavigationMenu() {
        ...
        final MenuButton messageBtn = new MenuButton(AppContext.getMessage(ProjectCommonI18nEnum.VIEW_MESSAGE), IconConstants.PROJECT_MESSAGE);
        addMenu(messageBtn);

        final MenuButton phaseBtn = new MenuButton(AppContext.getMessage(ProjectCommonI18nEnum.VIEW_MILESTONE), IconConstants.PROJECT_MILESTONE);
        addMenu(phaseBtn);

        final MenuButton taskBtn = new MenuButton(AppContext.getMessage(ProjectCommonI18nEnum.VIEW_TASK), IconConstants.PROJECT_TASK);
        addMenu(taskBtn);

        final MenuButton bugBtn = new MenuButton(AppContext.getMessage(ProjectCommonI18nEnum.VIEW_BUG), IconConstants.PROJECT_BUG);
        addMenu(bugBtn);

        final MenuButton userBtn = new MenuButton(AppContext.getMessage(ProjectCommonI18nEnum.VIEW_USERS), IconConstants.PROJECT_USER);
        addMenu(userBtn);
    }
        ...
        return new Button.ClickListener() {
            ...
            public void buttonClick(final ClickEvent event) {
                ...
                if (AppContext.getMessage(ProjectCommonI18nEnum.M_VIEW_PROJECT_LIST).equals(caption)) {
                    ...
                    EventBusFactory.getInstance().post(new ProjectEvent.MyProjectActivities(this, new ProjectScreenData.ViewActivities()));
                } else if (AppContext.getMessage(ProjectCommonI18nEnum.VIEW_MESSAGE).equals(caption)) {
                    EventBusFactory.getInstance().post(new MessageEvent.GotoList(this, null));
                } else if (AppContext.getMessage(ProjectCommonI18nEnum.VIEW_MILESTONE).equals(caption)) {
                    EventBusFactory.getInstance().post(new MilestoneEvent.GotoList(this, null));
                } else if (AppContext.getMessage(ProjectCommonI18nEnum.VIEW_TASK).equals(caption)) {
                    EventBusFactory.getInstance().post(new TaskEvent.GotoList(this, null));
                } else if (AppContext.getMessage(ProjectCommonI18nEnum.VIEW_BUG).equals(caption)) {
                    EventBusFactory.getInstance().post(new BugEvent.GotoList(this, null));
                } else if (AppContext.getMessage(ProjectCommonI18nEnum.VIEW_USERS).equals(caption)) {
