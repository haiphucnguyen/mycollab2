...
public class ContactDefaultDynaFormLayoutFactory {
    ...
    static {
        ...
        contactSection.addField(new TextDynaFieldBuilder().fieldName("firstname")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_FIRSTNAME))
                .fieldIndex(0).build());

        contactSection.addField(new PhoneDynaFieldBuilder().fieldName("officephone")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_OFFICE_PHONE))
                .fieldIndex(1).build());

        contactSection.addField(new TextDynaFieldBuilder().fieldName("lastname")
        ...
        contactSection.addField(new TextDynaFieldBuilder().fieldName("accountid")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_ACCOUNTS))
                .fieldIndex(4).build());

        contactSection.addField(new PhoneDynaFieldBuilder().fieldName("homephone")
        ...
        contactSection.addField(new PhoneDynaFieldBuilder().fieldName("otherphone")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_OTHER_PHONE))
                .fieldIndex(7).build());

        contactSection.addField(new TextDynaFieldBuilder().fieldName("department")
        ...
        contactSection.addField(new TextDynaFieldBuilder().fieldName("birthday")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_BIRTHDAY))
                .fieldIndex(11).build());

        contactSection.addField(new TextDynaFieldBuilder().fieldName("assistant")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_ASSISTANT))
                .fieldIndex(12).build());

        contactSection.addField(new BooleanDynaFieldBuilder().fieldName("iscallable")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_IS_CALLABLE))
                .fieldIndex(13).build());

        contactSection.addField(new TextDynaFieldBuilder().fieldName("assistantphone")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_ASSISTANT_PHONE))
                .fieldIndex(14).build());

        contactSection.addField(new TextDynaFieldBuilder().fieldName("assignuser")
                .displayName(AppContext.getMessage(GenericI18Enum.FORM_ASSIGNEE))
                .fieldIndex(15).build());

        contactSection.addField(new TextDynaFieldBuilder().fieldName("leadsource")
        ...
        addressSection.addField(new TextDynaFieldBuilder().fieldName("primaddress")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_PRIMARY_ADDRESS))
                .fieldIndex(0).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldName("otheraddress")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_OTHER_ADDRESS))
                .fieldIndex(1).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldName("primcity")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_PRIMARY_CITY))
                .fieldIndex(2).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldName("othercity")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_OTHER_CITY))
                .fieldIndex(3).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldName("primstate")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_PRIMARY_STATE))
                .fieldIndex(4).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldName("otherstate")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_OTHER_STATE))
                .fieldIndex(5).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldName("primpostalcode")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_PRIMARY_POSTAL_CODE))
                .fieldIndex(6).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldName("otherpostalcode")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_OTHER_POSTAL_CODE))
                .fieldIndex(7).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldName("primcountry")
                .displayName(AppContext.getMessage(ContactI18nEnum.FORM_PRIMARY_COUNTRY))
                .fieldIndex(8).build());

        addressSection.addField(new TextDynaFieldBuilder().fieldName("othercountry")
        ...
        descSection.addField(new TextDynaFieldBuilder().fieldName("description")
