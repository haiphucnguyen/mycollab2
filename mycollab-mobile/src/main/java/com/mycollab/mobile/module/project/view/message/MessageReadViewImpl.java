...
public class MessageReadViewImpl extends AbstractMobilePageView implements MessageReadView {
    ...
    private void displayItem() {
        ...
        ELabel messageTimePost = new ELabel().prettyDateTime(bean.getCreatedtime()).withStyleName(UIConstants.META_INFO).withUndefinedWidth();
        ...
        Component section = FormSectionBuilder.build(VaadinIcons.COMMENT, commentTitleLbl);
