...
public class ProjectDashboardViewImpl extends ProjectMobileMenuPageView implements ProjectDashboardView {
    ...
    public void displayDashboard() {
        ...
        ELabel projectIcon = ELabel.fontIcon(VaadinIcons.BUILDING_O).withStyleName("project-icon").withUndefinedWidth();
        ...
        if (totalAssignments > 0) {
            progressInfoLbl = new ELabel(UserUIContext.getMessage(ProjectI18nEnum.OPT_PROJECT_TICKET,
                    (totalAssignments - openAssignments), totalAssignments, (totalAssignments - openAssignments)
                            * 100 / totalAssignments)).withUndefinedWidth().withStyleName(UIConstants.META_INFO);
        } else {
            progressInfoLbl = new ELabel(UserUIContext.getMessage(ProjectI18nEnum.OPT_NO_TICKET)).withUndefinedWidth().withStyleName
        ...
        btnGroup.addComponent(new NavigationButtonWrap(VaadinIcons.INBOX, activityBtn));
        ...
        btnGroup.addComponent(new NavigationButtonWrap(VaadinIcons.USERS, userBtn));
    ...
    private static class NavigationButtonWrap extends MHorizontalLayout {
        NavigationButtonWrap(VaadinIcons icon, NavigationButton button) {
