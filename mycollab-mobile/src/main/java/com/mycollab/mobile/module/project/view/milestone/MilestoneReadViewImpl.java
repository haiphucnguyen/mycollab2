...
public class MilestoneReadViewImpl extends AbstractPreviewItemComp<SimpleMilestone> implements MilestoneReadView {
    ...
    protected ComponentContainer createBottomPanel() {
        ...
        Component issueSection = FormSectionBuilder.build(VaadinIcons.TICKET, ticketNavigatorButton);
        ...
        Component commentSection = FormSectionBuilder.build(VaadinIcons.COMMENT, relatedComments);
