    ...
    protected Component initContent() {
        try {
            ...
            if ("Account".equals(type)) {
                ...
                final SimpleAccount account = accountService.findById(typeid, UserUIContext.getAccountId());
                if (account != null) {
                ...
                final SimpleCampaign campaign = campaignService.findById(typeid, UserUIContext.getAccountId());
                if (campaign != null) {
                ...
                final SimpleContact contact = contactService.findById(typeid, UserUIContext.getAccountId());
                if (contact != null) {
                ...
                final SimpleLead lead = leadService.findById(typeid, UserUIContext.getAccountId());
                if (lead != null) {
                ...
                final SimpleOpportunity opportunity = opportunityService.findById(typeid, UserUIContext.getAccountId());
                if (opportunity != null) {
                ...
                final SimpleCase cases = caseService.findById(typeid, UserUIContext.getAccountId());
                if (cases != null) {
