        ...
        try {
            ...
            if ("Account".equals(type)) {
                ...
                if (account != null) {
                    ...
                    relatedLink = new ExternalResource(MyCollabAssets.newAssetLink("icons/16/crm/account.png"));
                }
                ...
                if (campaign != null) {
                    ...
                    relatedLink = new ExternalResource(MyCollabAssets.newAssetLink("icons/16/crm/campaign.png"));
                }
                ...
                if (contact != null) {
                    ...
                    relatedLink = new ExternalResource(MyCollabAssets.newAssetLink("icons/16/crm/contact.png"));
                ...
                if (lead != null) {
                    ...
                    relatedLink = new ExternalResource(MyCollabAssets.newAssetLink("icons/16/crm/lead.png"));
                }
                ...
                if (opportunity != null) {
                    ...
                    relatedLink = new ExternalResource(MyCollabAssets.newAssetLink("icons/16/crm/opportunity.png"));
                ...
                if (cases != null) {
                    ...
                    relatedLink = new ExternalResource(MyCollabAssets.newAssetLink("icons/16/crm/case.png"));
                }
            }
