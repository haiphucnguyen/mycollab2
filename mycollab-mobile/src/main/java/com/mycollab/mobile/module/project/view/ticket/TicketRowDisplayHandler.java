...
public class TicketRowDisplayHandler implements IBeanList.RowDisplayHandler<ProjectTicket> {
    ...
    public Component generateRow(IBeanList<ProjectTicket> host, final ProjectTicket ticket, int rowIndex) {
        ...
        ELabel priorityLbl = ELabel.html(priorityValue).withUndefinedWidth().withStyleName("priority-" + ticket.getPriority().toLowerCase());
        ...
        ELabel assigneeLbl = ELabel.html(assigneeDiv.write()).withStyleName(UIConstants.META_INFO).withUndefinedWidth();
