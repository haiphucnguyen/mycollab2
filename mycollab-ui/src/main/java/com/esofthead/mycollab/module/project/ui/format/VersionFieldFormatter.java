...
public final class VersionFieldFormatter extends FieldGroupFormatter {
    ...
    private VersionFieldFormatter() {
        ...
        generateFieldDisplayHandler("status", VersionI18nEnum.FORM_STATUS, new I18nHistoryFieldFormat(OptionI18nEnum.StatusI18nEnum.class));
        generateFieldDisplayHandler("description", GenericI18Enum.FORM_DESCRIPTION);
        generateFieldDisplayHandler("duedate", VersionI18nEnum.FORM_DUE_DATE, FieldGroupFormatter.DATE_FIELD);
    }
