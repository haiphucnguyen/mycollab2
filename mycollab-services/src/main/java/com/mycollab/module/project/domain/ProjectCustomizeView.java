...
public class ProjectCustomizeView extends ValuedBean {
    ...
    public final int hashCode() {
        return new HashCodeBuilder(45, 1827).append(id).build();
    }
     ...
     * @mbg.generated Fri Feb 01 07:44:13 CST 2019
     */
    public ProjectCustomizeView withDisplaystandup(Boolean displaystandup) {
        this.setDisplaystandup(displaystandup);
        return this;
    }
