...
public class ProjectRoleServiceImpl extends DefaultService<Integer, ProjectRole, ProjectRoleSearchCriteria> implements ProjectRoleService {
    ...
    static {
        ClassInfoMap.INSTANCE.put(ProjectRoleServiceImpl.class, new ClassInfo(ModuleNameConstants.INSTANCE.getPRJ(), ProjectTypeConstants.INSTANCE.getPROJECT_ROLE()));
    }
