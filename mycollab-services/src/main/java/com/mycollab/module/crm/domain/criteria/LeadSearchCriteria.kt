...
class LeadSearchCriteria : SearchCriteria() {
    ...
    companion object {
        ...
        val p_leadContactName: Param = CacheParamMapper.register(CrmTypeConstants.LEAD, GenericI18Enum.FORM_NAME,
                ConcatStringParam("contactname", "m_crm_lead", arrayOf("firstname", "lastname")))

        val p_accountName: Param = CacheParamMapper.register(CrmTypeConstants.LEAD, LeadI18nEnum.FORM_ACCOUNT_NAME,
                StringParam("accountname", "m_crm_lead", "accountName"))

        val p_website: Param = CacheParamMapper.register(CrmTypeConstants.LEAD, LeadI18nEnum.FORM_WEBSITE,
                StringParam("website", "m_crm_lead", "website"))

        val p_anyEmail: Param = CacheParamMapper.register(CrmTypeConstants.LEAD, LeadI18nEnum.FORM_ANY_EMAIL,
                CompositionStringParam("anyEmail", StringParam("", "m_crm_lead", "email")))

        val p_anyPhone: Param = CacheParamMapper.register(CrmTypeConstants.LEAD, LeadI18nEnum.FORM_ANY_PHONE,
        ...
        val p_anyCity: Param = CacheParamMapper.register(CrmTypeConstants.LEAD, LeadI18nEnum.FORM_ANY_CITY,
                CompositionStringParam("anyCity",
                        StringParam("", "m_crm_lead", "primCity"),
                        StringParam("", "m_crm_lead", "otherCity")))

        val p_billingCountry: Param = CacheParamMapper.register(CrmTypeConstants.LEAD, LeadI18nEnum.FORM_PRIMARY_COUNTRY,
                StringListParam("billingCountry", "m_crm_lead", "primCountry", Arrays.asList(*CountryValueFactory.countryList!!)))

        val p_shippingCountry: Param = CacheParamMapper.register(CrmTypeConstants.LEAD, LeadI18nEnum.FORM_OTHER_COUNTRY,
                StringListParam("shippingCountry", "m_crm_lead", "otherCountry",
                        Arrays.asList(*CountryValueFactory.countryList!!)))

        val p_statuses: Param = CacheParamMapper.register(CrmTypeConstants.LEAD, GenericI18Enum.FORM_STATUS,
                I18nStringListParam("status", "m_crm_lead", "status", listOf(*CrmDataTypeFactory.leadStatusList)))

        val p_sources = CacheParamMapper.register(CrmTypeConstants.LEAD, LeadI18nEnum.FORM_LEAD_SOURCE,
                I18nStringListParam("source", "m_crm_lead", "source", listOf(*CrmDataTypeFactory.leadSourceList)))

        val p_assignee: Param = CacheParamMapper.register<PropertyListParam<*>>(CrmTypeConstants.LEAD, GenericI18Enum.FORM_ASSIGNEE,
