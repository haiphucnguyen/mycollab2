...
@Service
@Transactional
class QuoteServiceImpl : DefaultService<Int, Quote, QuoteSearchCriteria>(), QuoteService {

    @Autowired
    private val quoteMapper: QuoteMapper? = null

    @Autowired
    private val quoteMapperExt: QuoteMapperExt? = null

    @Autowired
    private val quoteGroupProductService: QuoteGroupProductService? = null
