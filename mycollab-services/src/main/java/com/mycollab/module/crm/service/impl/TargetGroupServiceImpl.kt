...
@Service
@Transactional
class TargetGroupServiceImpl : DefaultService<Int, TargetGroup, TargetGroupSearchCriteria>(), TargetGroupService {

    @Autowired
    private val targetGroupMapper: TargetGroupMapper? = null

    @Autowired
    private val targetGroupMapperExt: TargetGroupMapperExt? = null
