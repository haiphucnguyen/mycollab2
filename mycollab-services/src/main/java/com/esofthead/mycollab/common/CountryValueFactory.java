...
public class CountryValueFactory {
    ...
    public static final String BAHAMAS = "Bahamas, The";
    ...
    public static final String CONGO_DEMOCRATIC_REPUBLIC_OF_THE = "Congo, Democratic Republic of the";
    public static final String CONGO_REPUBLIC_OF_THE = "Congo, Republic of the ";
    ...
    public static final String ELSALVADOR = "El Salvador";
    ...
    public static final String NETHERLANDS_ANTILLIES = "Netherlands Antilles";
    public static final String NEW_ZEALAN = "New Zealand";
    ...
    public static final String PALESTINIA_TERRITORIES = "Palestinian Territories";
    ...
    public static final String PORTUAGAL = "Portugal";
    ...
    public static final String SAO_TOME_AND_PRINCEPE = "Sao Tome and Principe";
    ...
    public static final String[] getCountryList() {
        return COUNTRIES;
    }
}
