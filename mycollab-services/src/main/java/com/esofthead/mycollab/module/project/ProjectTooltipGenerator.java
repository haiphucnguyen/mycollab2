...
public class ProjectTooltipGenerator {
    ...
    public static String generateToolTipTask(Locale locale, SimpleTask task, String siteURL, TimeZone timeZone) {
        ...
        try {
            ...
            String actualStartDate = DateTimeUtils.converToStringWithUserTimeZone(task.getEnddate(), dateFormat, timeZone);
    ...
    public static String generateToolTipRisk(Locale locale, SimpleRisk risk, String siteURL, TimeZone timeZone) {
        ...
        try {
            ...
            String datedue = DateTimeUtils.converToStringWithUserTimeZone(risk.getDatedue(), dateFormat, timeZone);
            Td cell32 = buildCellValue(datedue);
            Td cell33 = buildCellName(LocalizationHelper.getMessage(locale, RiskI18nEnum.FORM_RATING));
            Td cell34 = buildCellValue(risk.getLevel());
            trRow3.appendChild(cell31, cell32, cell33, cell34);
            tooltipManager.appendRow(trRow3);

            Tr trRow4 = new Tr();
            Td cell41 = buildCellName(LocalizationHelper.getMessage(locale, RiskI18nEnum.FORM_STATUS));
            Td cell42 = buildCellValue(LocalizationHelper.getMessage(locale, StatusI18nEnum.class, risk.getStatus()));
    ...
    public static String generateToolTipVersion(Locale locale, Version version, String siteURL, TimeZone timeZone) {
        ...
        try {
            ...
            String duedate = DateTimeUtils.converToStringWithUserTimeZone(version.getDuedate(), dateFormat, timeZone);
    ...
    public static String generateToolTipMilestone(Locale locale, SimpleMilestone milestone, String siteURL, TimeZone timeZone) {
        ...
        try {
            ...
            String startDate = DateTimeUtils.converToStringWithUserTimeZone(milestone.getStartdate(), dateFormat, timeZone);
            ...
            String endDate = DateTimeUtils.converToStringWithUserTimeZone(milestone.getEnddate(), dateFormat, timeZone);
    ...
    public static String generateToolTipStandUp(Locale locale, SimpleStandupReport standup, String siteURL, TimeZone timeZone) {
        ...
        try {
            ...
            H3 name = new H3();
            name.appendText(Jsoup.parse(DateTimeUtils.converToStringWithUserTimeZone(
