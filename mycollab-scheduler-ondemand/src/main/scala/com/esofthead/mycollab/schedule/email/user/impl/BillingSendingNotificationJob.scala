...
class BillingSendingNotificationJob extends GenericQuartzJobBean {
  ...
  private val INFORM_EXPIRE_ACCOUNT_TEMPLATE: String = "templates/email/billing/informAccountIsExpiredNotification.html"
  private val INFORM_FILLING_BILLING_INFORMATION_TEMPLATE: String = "templates/email/billing/remindAccountIsAboutExpiredNotification.html"
