package com.esofthead.mycollab.pro.module.project.view.bug.components;
...
public class UserOrderComponent extends AbstractUserOrderComponent {
    ...
    private static class GroupComponent extends VerticalLayout {
        ...
        GroupComponent(SimpleBug bug) {
            initComponent();
            Img img = new Img("", StorageFactory.getInstance().getAvatarPath(bug.getAssignUserAvatarId(), 32));
