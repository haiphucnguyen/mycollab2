...
public abstract class AbstractTimeTrackingDisplayComp extends VerticalLayout {
    ...
    protected static class ProjectComparator implements Comparator<SimpleItemTimeLogging>, Serializable {
        @Override
    ...
    protected static class UserComparator implements Comparator<SimpleItemTimeLogging>, Serializable {
        @Override
        public int compare(SimpleItemTimeLogging o1, SimpleItemTimeLogging o2) {
    ...
    protected static class DateComparator implements Comparator<SimpleItemTimeLogging>, Serializable {
        @Override
        public int compare(SimpleItemTimeLogging o1, SimpleItemTimeLogging o2) {
    ...
    protected static class BillableComparator implements Comparator<SimpleItemTimeLogging>, Serializable {
        @Override
        public int compare(SimpleItemTimeLogging o1, SimpleItemTimeLogging o2) {
    ...
    protected static class ValueComparator implements Comparator<SimpleItemTimeLogging>, Serializable {
        @Override
        public int compare(SimpleItemTimeLogging o1, SimpleItemTimeLogging o2) {
    ...
    protected static class SummaryComparator implements Comparator<SimpleItemTimeLogging>, Serializable {
        @Override
        public int compare(SimpleItemTimeLogging o1, SimpleItemTimeLogging o2) {
