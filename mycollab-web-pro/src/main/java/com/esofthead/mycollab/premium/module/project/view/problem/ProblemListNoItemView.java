...
public class ProblemListNoItemView extends ProjectListNoItemView {
    ...
    protected String viewTitle() {
        return AppContext.getMessage(ProblemI18nEnum.VIEW_NO_ITEM_TITLE);
    }

    @Override
    protected String viewHint() {
        return AppContext.getMessage(ProblemI18nEnum.VIEW_NO_ITEM_HINT);
    }

    @Override
    protected String actionMessage() {
        return AppContext.getMessage(ProblemI18nEnum.BUTTON_NEW_PROBLEM);
    }
    ...
    protected boolean hasPermission() {
        return CurrentProjectVariables.canWrite(ProjectRolePermissionCollections.PROBLEMS);
    }
}
