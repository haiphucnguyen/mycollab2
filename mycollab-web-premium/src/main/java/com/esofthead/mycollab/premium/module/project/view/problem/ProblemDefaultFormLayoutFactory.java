...
public class ProblemDefaultFormLayoutFactory {
	...
	static {
		...
		mainSection.addField(new TextDynaFieldBuilder()
				.fieldName(Problem.Field.description)
				.displayName(
		...
		mainSection.addField(new TextDynaFieldBuilder()
				.fieldName(Problem.Field.raisedbyuser)
				.displayName(
						AppContext.getMessage(ProblemI18nEnum.FORM_RAISED_BY))
				.fieldIndex(2).build());

		mainSection.addField(new TextDynaFieldBuilder()
				.fieldName(Problem.Field.type)
				.displayName(
						AppContext.getMessage(ProblemI18nEnum.FORM_RELATED))
				.fieldIndex(3).build());

		mainSection.addField(new TextDynaFieldBuilder()
				.fieldName(Problem.Field.assigntouser)
				.displayName(
		...
		mainSection
				.addField(new TextDynaFieldBuilder()
						.fieldName(Problem.Field.impact)
						.displayName(
								AppContext
		...
		mainSection.addField(new TextDynaFieldBuilder()
				.fieldName(Problem.Field.datedue)
				.displayName(
						AppContext.getMessage(ProblemI18nEnum.FORM_DATE_DUE))
				.fieldIndex(6).build());

		mainSection.addField(new TextDynaFieldBuilder()
				.fieldName(Problem.Field.priority)
				.displayName(
		...
		mainSection
				.addField(new TextDynaFieldBuilder()
						.fieldName(Problem.Field.status)
						.displayName(
								AppContext
		...
		mainSection.addField(new TextDynaFieldBuilder()
				.fieldName(Problem.Field.resolution)
				.displayName(
