...
CREATE TABLE `m_crm_lead` (
  ...
  `primCountryId` int(11) DEFAULT NULL,
  ...
  KEY `FK_m_crm_lead_4` (`primCountryId`),
  ...
  CONSTRAINT `FK_m_crm_lead_4` FOREIGN KEY (`primCountryId`) REFERENCES `s_country` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
--
-- Table structure for table `m_crm_leadsource`
--

DROP TABLE IF EXISTS `m_crm_leadsource`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `m_crm_leadsource` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `m_crm_leadsource`
--

LOCK TABLES `m_crm_leadsource` WRITE;
/*!40000 ALTER TABLE `m_crm_leadsource` DISABLE KEYS */;
INSERT INTO `m_crm_leadsource` VALUES (1,'Existing Customer'),(2,'Employee'),(3,'Partner'),(4,'Direct Mail'),(5,'Conference'),(6,'Other');
/*!40000 ALTER TABLE `m_crm_leadsource` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `m_crm_campaign_type`
--

DROP TABLE IF EXISTS `m_crm_campaign_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `m_crm_campaign_type` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `m_crm_campaign_type`
--

LOCK TABLES `m_crm_campaign_type` WRITE;
/*!40000 ALTER TABLE `m_crm_campaign_type` DISABLE KEYS */;
INSERT INTO `m_crm_campaign_type` VALUES (1,'type');
/*!40000 ALTER TABLE `m_crm_campaign_type` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `m_crm_campaign_status`
--

DROP TABLE IF EXISTS `m_crm_campaign_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `m_crm_campaign_status` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `m_crm_campaign_status`
--

LOCK TABLES `m_crm_campaign_status` WRITE;
/*!40000 ALTER TABLE `m_crm_campaign_status` DISABLE KEYS */;
INSERT INTO `m_crm_campaign_status` VALUES (1,'status');
/*!40000 ALTER TABLE `m_crm_campaign_status` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2012-11-02 18:00:02
